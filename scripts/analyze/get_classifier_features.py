...
toxicity_df = toxicity_df.reset_index(drop=True)
...
for _, row in full_df.iterrows():
    ...
    comment_info = pd.concat([comment_info, new_entry_df], ignore_index=True)


toxicity_df = pd.merge(toxicity_df, comment_info, on='id', how='left')
toxicity_df = toxicity_df.drop(columns=['tmp_text','text', 'masked_selftext', 'tmp_masked_selftext'])
